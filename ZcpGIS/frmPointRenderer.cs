...
namespace ZcpGIS
{
    public partial class frmPointRenderer : Form
    {
        #region 字段

        private MyMapObjects.moMapLayer _Layer;
        private MyMapObjects.moRenderer _Renderer;
        private Color _SimpleColor = Color.Black;
        ...
        private int _MarkerType = 0;  // 0实线 1虚线
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (tabControl1.SelectedIndex == 0)
            {
                ...
                if (_MarkerType == 0)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.Circle;
                }
                else if (_MarkerType == 1)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.SolidCircle;
                }
                else if (_MarkerType == 2)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.Triangle;
                }
                else if ( _MarkerType == 3)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.SolidTriangle;
                }
                else if (_MarkerType == 4)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.Square;
                }
                else if (_MarkerType == 5)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.SolidSquare;
                }
                else if (_MarkerType == 6)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.CircleDot;
                }
                else if (_MarkerType == 7)
                {
                    sSymbol.Style = moSimpleMarkerSymbolStyleConstant.CircleCircle;
                }
                // 可以继续设置符号的形式
        ...
        {
            _MarkerType = listBoxType.SelectedIndex;
        }
