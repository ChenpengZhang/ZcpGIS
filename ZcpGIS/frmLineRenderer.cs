...
namespace ZcpGIS
{
    public partial class frmLineRenderer : Form
    {
        #region 字段
        ...
        private int _LineType = 0;  // 0实线 1虚线
        ...
        private void frmLayerRenderer_Load(object sender, EventArgs e)
        {
            ...
            if (_Layer.ShapeType != moGeometryTypeConstant.MultiPolyline)
            {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (tabControl1.SelectedIndex == 0)
            {
                ...
                if (_LineType == 0)
                {
                    sSymbol.Style = moSimpleLineSymbolStyleConstant.Solid;
                }
                else
                {
                    sSymbol.Style = moSimpleLineSymbolStyleConstant.Dash;
                }
                // 可以继续设置符号的形式
        ...
        {
            _LineType = listBoxType.SelectedIndex;
        }
